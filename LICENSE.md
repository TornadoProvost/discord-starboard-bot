...
> Discord starboard bot, highlight popular messages 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

⭐ &nbsp;**Auto-highlight** — top-starred messages posted automatically

🔢 &nbsp;**Custom threshold** — set how many stars needed

🎨 &nbsp;**Custom emoji** — use any emoji as your star

⛔ &nbsp;**Ignore channels** — exclude NSFW or private channels

📊 &nbsp;**Top posts** — see the most starred messages ever

🔒 &nbsp;**Lock** — prevent self-starring
